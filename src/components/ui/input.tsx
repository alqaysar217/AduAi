    ...
    return (
      <input
        ...
        className={cn(
          ...
          "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2", // Base ShadCN focus
          "input-base", // Apply custom focus defined in globals.css
          className
        )}
        ref={ref}
        {...props}
